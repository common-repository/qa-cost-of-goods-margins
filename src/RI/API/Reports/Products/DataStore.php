...
class DataStore extends ReportsDataStore implements DataStoreInterface
{
     ...
     * @var string
     */
    const TABLE_NAME = 'qa_cog_order_product_lookup';
    ...
    protected function get_sql_query_params($query_args)
    {
        ...
        if ($order_status_filter) {
            $sql_query_params['from_clause'] .= " JOIN {$wpdb->prefix}qa_cog_order_stats ON {$order_product_lookup_table}.order_id = {$wpdb->prefix}qa_cog_order_stats.order_id";
