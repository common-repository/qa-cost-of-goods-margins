...
final class Assets
{
    ...
    public function init()
    {
        ...
        if ('admin.php' === $pagenow && QA_COG_RI_SLUG === sanitize_key($_GET['page'])) {
    ...
    public function styles()
    {
        ...
        wp_enqueue_style('qa-cog', QA_COG_BASE_URL . 'assets/dist/quickassortments/quickassortments.css', null, '1.0.0', 'all');
    ...
    public function ri_styles_scripts()
    {
        ...
        wp_register_style(
            'qa-admin-app',
            QA_COG_BASE_URL . 'assets/dist/app/style.css',
            ['wc-components'],
            null
        );
        ...
        wp_register_script(
            'wc-csv',
            QA_COG_BASE_URL . 'assets/dist/csv-export/index.js',
            [],
            null,
            true
        );
        ...
        wp_register_script(
            'wc-currency',
            QA_COG_BASE_URL . 'assets/dist/currency/index.js',
            ['wc-number'],
            null,
            true
        );
        ...
        wp_register_script(
            'wc-navigation',
            QA_COG_BASE_URL . 'assets/dist/navigation/index.js',
            [],
            null,
            true
        );
        ...
        wp_register_script(
            'wc-number',
            QA_COG_BASE_URL . 'assets/dist/number/index.js',
            [],
            null,
            true
        );
        ...
        wp_register_script(
            'wc-date',
            QA_COG_BASE_URL . 'assets/dist/date/index.js',
            ['wp-date', 'wp-i18n'],
            null,
            true
        );
